...
const OnwardsCard = ({ item, fmtCurrency }) => {
  ...
  return (
    <div className="p-4 rounded-lg" style={{ background: 'linear-gradient(145deg, #F5DEB3, #E8D4A0)' }}>
      ...
      {/* Box Details */}
      <div className="text-sm font-medium mb-2" style={{ color: 'rgba(26,18,11,0.7)' }}>
      ...
      {item.salePriceUSD && (
        <div className="flex justify-between items-center mt-1">
          <div className="text-sm font-medium" style={{ color: 'rgba(26,18,11,0.5)' }}>Sold</div>
          <div className="text-sm font-medium" style={{ color: 'rgba(26,18,11,0.7)' }}>{item.saleDate ? fmt.date(item.saleDate) : '—'}</div>
